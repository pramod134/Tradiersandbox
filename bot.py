...
CHANNEL_HIST = defaultdict(lambda: deque(maxlen=20))

# --- Validation helper (equities) ---
import re as _re_s
_SYMBOL_RE = _re_s.compile(r"^[A-Z][A-Z0-9.\-]{0,9}$")
...
def is_valid_equity_symbol(sym: str) -> bool:
    ...
    if not s:
        return False
    return bool(_SYMBOL_RE.match(s))  # keep last ~20 turns per channel
